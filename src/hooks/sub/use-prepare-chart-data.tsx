import { CHART_DATA_OPTIONS } from '@/components/modules/sensors/_components/sensor-constants';
...
const usePrepareChartData = ({soilData}: Props) => {
    /**
    ...
    const chartData = useMemo(() => {
      ...
      deviceData.forEach(dev => {
        ...
        return {
          ...
          temperatureSensorChartOptions: CHART_DATA_OPTIONS?.temperature,
          moistureSensorChartOptions: CHART_DATA_OPTIONS?.moisture,
          nitrogenSensorChartOptions: CHART_DATA_OPTIONS?.nitrogen,
          phosphorousSensorChartOptions: CHART_DATA_OPTIONS?.phosphorous,
          phSensorChartOptions: CHART_DATA_OPTIONS?.ph,
          potassiumSensorChartOptions: CHART_DATA_OPTIONS?.potassium,
          salinitySensorChartOptions: CHART_DATA_OPTIONS?.salinity,
          electricalConductivitySensorChartOptions: CHART_DATA_OPTIONS?.ec,
        };
