  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'bg-cta-gradient': 'linear-gradient(90deg, var(--brand) 0%, color-mix(in oklab, var(--brand) 70%, white) 100%)',
        'poly-footer' : "url('/images/assets/background/poly-footer-bg.jpg')",
      },
      content: {
